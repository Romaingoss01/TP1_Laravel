<nav class="bg-gray-800">
    ...
    <div class="sm:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pt-2 pb-3">
        <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
        <a href="{{ url('/accueil')}}" class="block rounded-md px-3 py-2 text-base font-medium {{ request()->is('accueil') ? "bg-gray-900 text-white" : "text-gray-300 hover:bg-gray-700 hover:text-white" }}" aria-current="page">Accueil</a>
